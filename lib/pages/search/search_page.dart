...
import 'package:wan_android_flutter/common_ui/webview/jumpToWeb.dart';
import 'package:wan_android_flutter/common_ui/webview/webview_page.dart';
import 'package:wan_android_flutter/common_ui/webview/webview_widget.dart';
        ...
        child: Scaffold(
          ...
          children: [
            ...
            _searchResultsView(onItemTap: (item) {
              openWeb(context: context, loadResource:item?.link ?? "", title: item?.title, showTitle: true,
